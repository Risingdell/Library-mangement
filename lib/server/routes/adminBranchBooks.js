 ...
 */
router.get('/pending-requests', authenticateAdmin, (req, res) => {
 ...
 */
router.get('/approved-requests', authenticateAdmin, (req, res) => {
 ...
 */
router.get('/all-requests', authenticateAdmin, (req, res) => {
 ...
 */
router.post('/reject', authenticateAdmin, (req, res) => {
  const { request_id: requestId, rejection_reason: rejectionReason } = req.body;
  const adminId = req.admin.id;
 ...
 */
router.post('/confirm-handover', authenticateAdmin, async (req, res) => {
  const { request_id: requestId } = req.body;
  const adminId = req.admin.id;
